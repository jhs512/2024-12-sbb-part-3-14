...
//                .orElseThrow(() -> new DataNotFoundException("질문 카테고리를 찾을 수 없습니다."));
//
//        for(int i=1; i<=100; i++) {
//            Question question = createQuestion(String.format("%d번 질문입니다!", i),
//                    String.format("%d번의 상세 질문 내용 입니다!!", i), siteUser, category);
...
//            Category newCategory = Category.builder().categoryType(category).build();
...
//    }
//
//    private static Question createQuestion(String subject, String content, SiteUser siteUser, Category category) {
//        return Question
//                .builder()
//                .subject(subject)
//                .category(category)
